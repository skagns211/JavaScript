...
const deselectedOptions = [
  'BMW 1 Series #Hatchback #Compact',
  'BMW 2 Series #Grancoupe',
  'BMW 3 Series #Hatchback #Sedan',
  'BMW 4 Series #Coupe #Sport',
  'BMW 5 Series #Sedan #Signature',
  'BMW X1 #SUV #Compact',
  'BMW X2 #SUV #Compact',
  'BMW X3 #SUV',
  'BMW X4 #SUV',
...
export const Autocomplete = () => {
  ...
  return (
    <div className='autocomplete-wrapper'>
      ...
      {hasText ? <DropDown options={options} handleComboBox={handleDropDownClick}></DropDown> : null}
    </div>
  );
};
